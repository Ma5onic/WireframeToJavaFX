...
class ScreenNavigatorControllerscreen2 extends AbstractNavigatorController {
	...
	/* Generated */
	@FXML
	def handleButtonAction69(ActionEvent event) {				
...
/* Generated */
	@FXML
	def handleButtonAction71(ActionEvent event) {
		...
		&& FilenameUtils.getName(it.URI.path) == "screen2.screen"]
	...
	/* Generated */
	@FXML
	def handleButtonAction79(ActionEvent event) {				
